...
|---|---|---|
| [[db.README\|sycren-db]] | Database | Optional — analytics and logging |
| OpenAI API | External | GPT-4o-mini for moderation and classification |
| Discord.js v14 | External | Discord API library |

## Integrations (Future)

| Service | Integration |
|---|---|
| [[app.README\|sycren-app]] | Security alerts, project notifications |
| [[studio.README\|sycren-studio]] | Client support tickets via Discord |

## Documentation

- [[discord-bot.requirements]] — Full PRD
