...
|---|---|
| [[cloud.README]] | sycren-cloud overview |
| [[cloud.todo]] | Implementation plan |
| [[db.requirements\|sycren-db requirements]] | Shared schema for User, Server |
| [[app.requirements\|sycren-app requirements]] | SSO and billing integration |
...
| [[domains.requirements\|sycren-domains requirements]] | Domain-to-cloud integration |
| [[security.requirements\|sycren-security requirements]] | WAF protection for cloud servers |
